        ...
        <div class="box-body">
          <table class="table table-bordered table-striped dt-responsive tablas">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td><img src="views/images/productos/default/anonymous.png" class="img-thumbnail" width="40px"></td>
                <td>0001</td>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background: #D81B60; color: white;">
          ...
          <h4 class="modal-title">Agregar Produto</h4>
        </div>

        <div class="modal-body">
          <div class="box-body">

            <!-- ENTREDA PARA EL CODIGO -->
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevaCategoría">
            ...
            <div class="form-group">
              ...
              <input type="file" id="nuevaFoto" name="nuevaImagen">
              <p class="help-block">Peso máximo de la imagen 2 MB</p>
              <img src="views/images/productos/default/anonymous.png" class="img-thumbnail" width="100px">
            </div>
